...
_.extend(TAPi18n.prototype, {                                                                                         // 1
  ...
  _registerHelpers: function(package_name, template) {                                                                // 2
    ...
    if (package_name !== globals.project_translations_domain) {                                                       // 98
      if ((Template[template] != null) && (Template[template].helpers != null)) {                                     // 100
        ...
        Template[template].helpers(helpers);                                                                          // 101
      }                                                                                                               //
    } else {                                                                                                          //
      UI.registerHelper(this.conf.helper_name, underscore_helper);                                                    // 108
      UI.registerHelper("languageTag", (function(_this) {                                                             // 108
        return function() {                                                                                           //
  ...
  _prepareLanguageSpecificTranslator: function(lang_tag) {                                                            // 2
    var dfd;                                                                                                          // 121
    dfd = (new $.Deferred()).resolve().promise();                                                                     // 121
    if (lang_tag in this._languageSpecificTranslatorsTrackers) {                                                      // 123
      return dfd;                                                                                                     // 124
    }                                                                                                                 //
    this._languageSpecificTranslatorsTrackers[lang_tag] = new Tracker.Dependency;                                     // 121
    if (!(lang_tag in this._languageSpecificTranslators)) {                                                           // 128
      dfd = this._loadLanguage(lang_tag).done((function(_this) {                                                      // 129
        return function() {                                                                                           //
          _this._languageSpecificTranslators[lang_tag] = _this._getSpecificLangTranslator(lang_tag);                  // 131
    ...
    return (function(_this) {                                                                                         //
      return function(key, options, lang_tag) {                                                                       //
        ...
        if (((options != null ? options.lang : void 0) != null) && ((options != null ? options.lng : void 0) == null)) {
          options.lng = options.lang;                                                                                 // 144
        }                                                                                                             //
        if (((options != null ? options.lng : void 0) != null) && (lang_tag == null)) {                               // 146
          lang_tag = options.lng;                                                                                     // 147
          delete options.lng;                                                                                         // 147
        }                                                                                                             //
        if (lang_tag != null) {                                                                                       // 157
          _this._prepareLanguageSpecificTranslator(lang_tag);                                                         // 158
          _this._languageSpecificTranslatorsTrackers[lang_tag].depend();                                              // 158
          if (lang_tag in _this._languageSpecificTranslators) {                                                       // 162
            return _this._languageSpecificTranslators[lang_tag]((TAPi18n._getPackageDomain(package_name)) + ":" + key, options);
          } else {                                                                                                    //
            return TAPi18next.t((TAPi18n._getPackageDomain(package_name)) + ":" + key, options);                      // 165
          }                                                                                                           //
        }                                                                                                             //
        _this._language_changed_tracker.depend();                                                                     // 143
  ...
  _abortPreviousSetLang: null,                                                                                        // 2
  setLanguage: function(lang_tag) {                                                                                   // 2
    var isAborted, self;                                                                                              // 178
    self = this;                                                                                                      // 178
    if (typeof this._abortPreviousSetLang === "function") {                                                           //
      this._abortPreviousSetLang();                                                                                   //
    }                                                                                                                 //
    isAborted = false;                                                                                                // 178
    this._abortPreviousSetLang = function() {                                                                         // 178
      return isAborted = true;                                                                                        //
    };                                                                                                                //
    return this._loadLanguage(lang_tag).then((function(_this) {                                                       //
      return function() {                                                                                             //
        if (!isAborted) {                                                                                             // 186
          TAPi18next.setLng(lang_tag);                                                                                // 187
          _this._language_changed_tracker.changed();                                                                  // 187
  ...
  getLanguage: function() {                                                                                           // 2
    var session_lang;                                                                                                 // 193
    if (!this._enabled()) {                                                                                           // 193
      return null;                                                                                                    // 194
    }                                                                                                                 //
    session_lang = Session.get(this._loaded_lang_session_key);                                                        // 193
    if (session_lang != null) {                                                                                       // 198
      return session_lang;                                                                                            //
    } else {                                                                                                          //
